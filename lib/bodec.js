define("bodec", function () {
  ...
  function toString(binary, encoding) {
    return ((encoding && toStringCoders[encoding]) ||
            toStringCoders.utf8)(binary);
  }
  ...
  function fromString(string, encoding) {
    return ((encoding && fromStringCoders[encoding]) ||
            fromStringCoders.utf8)(string);
  }
});
